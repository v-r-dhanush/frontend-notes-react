...
import {GET,POST,PUT,DELETE} from '../../service/HTTP.Service'
...
const deleteData = createAsyncThunk("api/deleteData",async (id)=>{
   // await axios.delete(`${API_URL}/${id}`);
    await DELETE(`${API_URL}/${id}`);
    return id;
});

const addData = createAsyncThunk("api/addData",async (newUser)=>{
